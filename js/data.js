...
// let allUsersArray = [];
// let aadhaarFile = null; // NEW: Aadhaar file variable
...
//   // 🆕 Aadhaar image auto-fill
//   const aadhaarText = document.getElementById("aadhaarText");
//   const aadhaarPreview = document.getElementById("aadhaarPreview"); // optional preview element
//   if (data.aadhaarImage) {
//     aadhaarText.value = "Existing Aadhaar Image";
//     // if you have an <img id="aadhaarPreview"> somewhere
//     if (aadhaarPreview) {
